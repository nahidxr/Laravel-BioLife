                        ...
                        <div class="media">
                            <div class="child-elememt">
                                <a href="#" class="link-to">
                                    <img src="site/images/home-03/slide-01-child-01.png" width="604" height="580"
                                        alt="">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="slide-contain slider-opt03__layout01">
                        <div class="media">
                            <div class="child-elememt"><a href="#" class="link-to"><img
                                        src="site/images/home-03/slide-01-child-01.png" width="604" height="580"
                                        alt=""></a></div>
                        </div>
                        <div class="text-content">
                            <i class="first-line">Pomegranate</i>
                            ...
                            <div class="banner-contain">
                                <div class="media">
                                    <a href="#" class="bn-link">
                                        <figure><img src="site/images/home-03/bn_special_org.jpg" width="616"
                                    ...
                                    <div class="contain-product layout-default">
                                        <div class="product-thumb">
                                            <a href="#" class="link-to-product">
                                                <img src="{{ asset("storage/$p->featured_image") }}" alt="Vegetables"
                                        ...
                                        <div class="info">
                                            ...
                                            <h4 class="product-title"><a href="{{ url("item/$p->id") }}"
                                                    class="pr-name">{{ $p->name }}</a>
                                            </h4>
                                            <div class="price ">
                                                <ins><span class="price-amount"><span
                                                            class="currencySymbol">£</span>{{ $p->price_after_discount }}</span></ins>
                                                <del><span class="price-amount"><span
                                                            class="currencySymbol">£</span>{{ $p->price }}</span></del>
                                            </div>
                        ...
                        <div class="banner-contain">
                            <div class="media background-biolife-banner__promotion">
                                <div class="img-moving position-1">
                                    <img src="site/images/home-03/img-moving-pst-1.png" width="149" height="139"
                                        alt="img msv">
                                </div>
                                <div class="img-moving position-2">
                                    <img src="site/images/home-03/img-moving-pst-2.png" width="185" height="265"
                                        alt="img msv">
                                </div>
                                <div class="img-moving position-3">
                                    <img src="site/images/home-03/img-moving-pst-3-cut.png" width="384" height="151"
                                        alt="img msv">
                                </div>
                                <div class="img-moving position-4">
                                    <img src="site/images/home-03/img-moving-pst-4.png" width="198" height="269"
                                        alt="img msv">
                                </div>
                            </div>
                            <div class="text-content">
                                    ...
                                    <ul class="products biolife-carousel nav-top-right nav-none-on-mobile"
                                        ...
                                        <li class="product-item">
                                            <div class="contain-product deal-layout contain-product__deal-layout">
                                                <div class="product-thumb">
                                                    <a href="#" class="link-to-product">
                                                        <img src="site/images/home-03/product_deal_330x330.jpg" alt="dd"
                                        ...
                                        <li class="product-item">
                                            <div class="contain-product deal-layout contain-product__deal-layout">
                                                <div class="product-thumb">
                                                    <a href="#" class="link-to-product">
                                                        <img src="site/images/home-03/product_deal-02_330x330.jpg"
                                        ...
                                        <li class="product-item">
                                            <div class="contain-product deal-layout contain-product__deal-layout">
                                                <div class="product-thumb">
                                                    <a href="#" class="link-to-product">
                                                        <img src="site/images/home-03/product_deal-03_330x330.jpg"
                                                            alt="dd" width="330" height="330" class="product-thumnail">
                                                    </a>
                                                    <div class="labels">
                                                        <span class="sale-label">-50%</span>
                                    ...
                                    <ul class="products biolife-carousel eq-height-contain nav-center-03 nav-none-on-mobile row-space-29px"
                                        ...
                                        <li class="product-item">
                                            <div
                                                ...
                                                <div class="product-thumb">
                                                    <a href="#" class="link-to-product">
                                                        <img src="site/images/products/p-19.jpg" alt="dd" width="270"
                                        ...
                                        <li class="product-item">
                                            <div
                                                ...
                                                <div class="product-thumb">
                                                    <a href="#" class="link-to-product">
                                                        <img src="site/images/products/p-03.jpg" alt="dd" width="270"
                                                            height="270" class="product-thumnail">
                                                    </a>
                                                </div>
                                                <div class="info">
                                        ...
                                        <li class="product-item">
                                            <div
                                                ...
                                                <div class="product-thumb">
                                                    <a href="#" class="link-to-product">
                                                        <img src="site/images/products/p-02.jpg" alt="dd" width="270"
                                                            height="270" class="product-thumnail">
                                                    </a>
                                                </div>
                                                <div class="info">
                                        ...
                                        <li class="product-item">
                                            <div
                                                ...
                                                <div class="product-thumb">
                                                    <a href="#" class="link-to-product">
                                                        <img src="site/images/products/p-22.jpg" alt="dd" width="270"
                                                            height="270" class="product-thumnail">
                                                    </a>
                                                </div>
                                                <div class="info">
                                        ...
                                        <li class="product-item">
                                            <div
                                                ...
                                                <div class="product-thumb">
                                                    <a href="#" class="link-to-product">
                                                        <img src="site/images/products/p-20.jpg" alt="dd" width="270"
                                                            height="270" class="product-thumnail">
                                                    </a>
                                                </div>
                                                <div class="info">
                                        ...
                                        <li class="product-item">
                                            <div
                                                ...
                                                <div class="product-thumb">
                                                    <a href="#" class="link-to-product">
                                                        <img src="site/images/products/p-05.jpg" alt="dd" width="270"
                                                            height="270" class="product-thumnail">
                                                    </a>
                                                </div>
                                                <div class="info">
                                        ...
                                        <li class="product-item">
                                            <div
                                                ...
                                                <div class="product-thumb">
                                                    <a href="#" class="link-to-product">
                                                        <img src="site/images/products/p-06.jpg" alt="dd" width="270"
                                                            height="270" class="product-thumnail">
                                                    </a>
                                                </div>
                                                <div class="info">
                        ...
                        <ul class="biolife-carousel nav-center-bold nav-none-on-mobile"
                            ...
                            <li>
                                <div class="biolife-brd-container">
                                    <a href="#" class="link">
                                        <figure><img src="site/images/home-03/brd-01.jpg" width="214" height="163"
                                                alt="">
                                        </figure>
                                    </a>
                                </div>
                            ...
                            <li>
                                <div class="biolife-brd-container">
                                    <a href="#" class="link">
                                        <figure><img src="site/images/home-03/brd-02.jpg" width="214" height="163"
                                                alt="">
                                        </figure>
                                    </a>
                                </div>
                            ...
                            <li>
                                <div class="biolife-brd-container">
                                    <a href="#" class="link">
                                        <figure><img src="site/images/home-03/brd-03.jpg" width="153" height="163"
                                                alt="">
                                        </figure>
                                    </a>
                                </div>
                            ...
                            <li>
                                <div class="biolife-brd-container">
                                    <a href="#" class="link">
                                        <figure><img src="site/images/home-03/brd-04.jpg" width="224" height="163"
                                                alt="">
                                        </figure>
                                    </a>
                                </div>
                        ...
                        <ul class="biolife-carousel nav-center nav-none-on-mobile xs-margin-top-36px"
                                ...
                                <div class="post-item effect-01 style-bottom-info layout-02 ">
                                    <div class="thumbnail">
                                        <a href="#" class="link-to-post"><img
                                                src="site/images/our-blog/post-thumb-01.jpg" width="370" height="270"
                                                alt=""></a>
                                        <div class="post-date">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <div class="post-meta">
                                            <a href="#" class="post-meta__item author"><img
                                                    src="site/images/home-03/post-author.png" width="28" height="28"
                            ...
                            <li>
                                <div class="post-item effect-01 style-bottom-info layout-02">
                                    <div class="thumbnail">
                                        <a href="#" class="link-to-post"><img
                                                src="site/images/our-blog/post-thumb-02.jpg" width="370" height="270"
                                                alt=""></a>
                                        <div class="post-date">
                                            <span class="date">26</span>
                                            <span class="month">dec</span>
                            ...
                            <li>
                                <div class="post-item effect-01 style-bottom-info layout-02">
                                    <div class="thumbnail">
                                        <a href="#" class="link-to-post"><img
                                                src="site/images/our-blog/post-thumb-04.jpg" width="370" height="270"
                                                alt=""></a>
                                        <div class="post-date">
                                            <span class="date">26</span>
                                            <span class="month">dec</span>
                            ...
                            <li>
                                <div class="post-item effect-01 style-bottom-info layout-02">
                                    <div class="thumbnail">
                                        <a href="#" class="link-to-post"><img
                                                src="site/images/our-blog/post-thumb-03.jpg" width="370" height="270"
                                                alt=""></a>
                                        <div class="post-date">
                                            <span class="date">26</span>
                                            <span class="month">dec</span>
                            ...
                            <li>
                                <div class="post-item effect-01 style-bottom-info layout-02">
                                    <div class="thumbnail">
                                        <a href="#" class="link-to-post"><img
                                                src="site/images/our-blog/post-thumb-05.jpg" width="370" height="270"
                                                alt=""></a>
                                        <div class="post-date">
                                            <span class="date">26</span>
                                            <span class="month">dec</span>
                            ...
                            <li>
                                <div class="post-item effect-01 style-bottom-info layout-02">
                                    <div class="thumbnail">
                                        <a href="#" class="link-to-post"><img
                                                src="site/images/our-blog/post-thumb-06.jpg" width="370" height="270"
                                                alt=""></a>
                                        <div class="post-date">
                                            <span class="date">26</span>
                                            <span class="month">dec</span>

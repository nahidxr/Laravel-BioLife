        ...
        <div class="container">
                ...
                <div class="row">
                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-thumbnail" data-title="Product Name">
                                            ...
                                            <div class="action">
                                                ...
                                                <a href="{{ url("/cart/remove/$cart->id") }}" class="remove"><i
                                        ...
                                        <td class="product-subtotal" data-title="Total">
                                            <div class="price price-contain">
                                                <ins><span class="price-amount"><span
                                                            class="currencySymbol">£</span>{{ $cart->price * $cart->quantity }}</span></ins>
                                    ...
                                    {{-- <tr class="cart_item">
                                        <td class="product-thumbnail" data-title="Product Name">
                                            <a class="prd-thumb" href="#">
                                                <figure><img width="113" height="113"
                                                        src="site/images/shippingcart/pr-02.jpg" alt="shipping cart">
                                                </figure>
                                            </a>
                    ...
                    @endforeach --}}
                            ...
                            <div class="subtotal-line">
                                ...
                                <span class="stt-price">£{{ $total + $shipping_price }}</span>
                            </div>
            ...
            <div class="product-related-box single-layout">
                        ...
                        <div class="contain-product layout-default">
                            <div class="product-thumb">
                                <a href="#" class="link-to-product">
                                    <img src="{{ asset("storage/$p->featured_image") }}" alt="dd" width="270"
                                ...
                                <div class="slide-down-box">
                                    ...
                                    <div class="buttons">
                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart"
                                                aria-hidden="true"></i></a>
                                        <a href="{{ url("/add_product/$p->id") }}" class="btn add-to-cart-btn"><i
                ...
                <div class="contain-product layout-default">
                    <div class="product-thumb">
                        <a href="#" class="link-to-product">
                            <img src="{{ asset("site/images/products/p-14.jpg") }}" alt="dd" width="270" height="270"
...
$.ajax({
	url:"/cart/cart_remove_one_product"+id,
...
$.ajax({
	url:"/cart/cart_add_one_product/"+id,
	success: function(result){
	var old =$("#cart_value_"+id).val()+1;
	$("#cart_value_"+id).val(old);
   }

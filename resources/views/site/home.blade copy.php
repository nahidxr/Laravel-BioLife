                        ...
                        <div class="col-md-3 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{ asset("storage/$p->featured_image") }}" alt="" class="pro-image-front">
                                    <img src="{{ asset("storage/$p->featured_image") }}" alt="" class="pro-image-back">
                                ...
                                <div class="item-info-product ">
                                    ...
                                    <div class="info-product-price">
                                        <span class="item_price">${{ $p->price_after_discount }}</span>

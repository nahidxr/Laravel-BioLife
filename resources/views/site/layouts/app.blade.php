...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/site/css/main-color.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="site/css/nice-select.css">
    <link rel="stylesheet" type="text/css" href="site/css/slick.min.css">
    <link rel="stylesheet" type="text/css" href="site/css/style.css">
    <link rel="stylesheet" type="text/css" href="site/css/main-color.css"> --}}
...
<body class="biolife-body">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-9">
                        <section class="footer-item">
                            <a href="index-2.html" class="logo footer-logo"><img src="site/images/organic-3.png"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="payment-methods">
                            <ul>
                                <li><a href="#" class="payment-link"><img src="site/images/card1.jpg" width="51"
                                            height="36" alt=""></a></li>
                                <li><a href="#" class="payment-link"><img src="site/images/card2.jpg" width="51"
                                            height="36" alt=""></a></li>
                                <li><a href="#" class="payment-link"><img src="site/images/card3.jpg" width="51"
                                            height="36" alt=""></a></li>
                                <li><a href="#" class="payment-link"><img src="site/images/card4.jpg" width="51"
                                            height="36" alt=""></a></li>
                                <li><a href="#" class="payment-link"><img src="site/images/card5.jpg" width="51"
                                            height="36" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="block-global-contain">
            ...
            <div class="glb-item languages">
                ...
                <ul class="list inline">
                    <li class="list-item"><a href="#"><img src="site/images/languages/us.jpg" alt="flag" width="24"
                                height="18"></a></li>
                    <li class="list-item"><a href="#"><img src="site/images/languages/fr.jpg" alt="flag" width="24"
                                height="18"></a></li>
                    <li class="list-item"><a href="#"><img src="site/images/languages/ger.jpg" alt="flag" width="24"
                                height="18"></a></li>
                    <li class="list-item"><a href="#"><img src="site/images/languages/jap.jpg" alt="flag" width="24"
                                height="18"></a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="biolife-quickview-inner">
                <div class="media">
                    <ul class="biolife-carousel quickview-for"
                        ...
                        <li><img src="site/images/details-product/detail_01.jpg" alt="" width="500" height="500"></li>
                        <li><img src="site/images/details-product/detail_02.jpg" alt="" width="500" height="500"></li>
                        <li><img src="site/images/details-product/detail_03.jpg" alt="" width="500" height="500"></li>
                        <li><img src="site/images/details-product/detail_04.jpg" alt="" width="500" height="500"></li>
                        <li><img src="site/images/details-product/detail_05.jpg" alt="" width="500" height="500"></li>
                        <li><img src="site/images/details-product/detail_06.jpg" alt="" width="500" height="500"></li>
                        <li><img src="site/images/details-product/detail_07.jpg" alt="" width="500" height="500"></li>
                    </ul>
                    <ul class="biolife-carousel quickview-nav"
                        ...
                        <li><img src="site/images/details-product/thumb_01.jpg" alt="" width="88" height="88"></li>
                        <li><img src="site/images/details-product/thumb_02.jpg" alt="" width="88" height="88"></li>
                        <li><img src="site/images/details-product/thumb_03.jpg" alt="" width="88" height="88"></li>
                        <li><img src="site/images/details-product/thumb_04.jpg" alt="" width="88" height="88"></li>
                        <li><img src="site/images/details-product/thumb_05.jpg" alt="" width="88" height="88"></li>
                        <li><img src="site/images/details-product/thumb_06.jpg" alt="" width="88" height="88"></li>
                        <li><img src="site/images/details-product/thumb_07.jpg" alt="" width="88" height="88"></li>
                    </ul>
                </div>
    ...
    <script src="{{ asset('site/js/biolife.framework.js') }}"></script>

          ...
          <div class="container">
              ...
              <div class="top-bar right">
                  ...
                  <ul class="horizontal-menu">
                      ...
                      {{-- <li><a  href="{{ url('/login') }}" class="login-link"><i
                      ...
                      <form action="{{ url('/logout') }}" method="POST">
                          @csrf
                          {{-- <li><button type="submit" class="login-link">
                              <i class="fas fa-sign-out-alt">Log-Out</i></button></li> --}}
                          <li><button  class="login-link" style="font-size:16px">LogOut <i class="fa fa-sign-out"></i></button></li>
                      </form>
                      @else
                      <li><a href="{{ url('/login') }}" class="login-link"><i
                                  class="biolife-icon icon-login"></i>Login/Register</a></li>
                                                  ...
                                                  <div class="minicart-item">
                                                      ...
                                                      <div class="left-info">
                                                          <div class="product-title"><a href="#"
                                                                  class="product-name">{{ $cart->name }}</a></div>
                                                          <div class="price">
                                                      ...
                                                      <div class="action">
                                                          ...
                                                          <a href="{{ url("/cart/remove/$cart->id") }}"
                                                              class="remove2"><i class="fa fa-trash-o"
                                                                  aria-hidden="true"></i></a>
                                                      </div>
                                                  </div>
                                              </li>

    ...
    <div class="container">
        ...
        <div id="main-content" class="main-content">
            ...
            <div class="sumary-product single-layout">
                <div class="media">
                    ...
                    <ul class="biolife-carousel slider-for"
                        ...
                        <li><img src="{{ asset("storage/$item->path" ) }}" alt="" width="500" height="500">
                        </li>
                        @endforeach
                        {{-- <li><img src="site/images/details-product/p02.jpg" alt="" width="500" height="500"></li>
                        <li><img src="site/images/details-product/p03.jpg" alt="" width="500" height="500"></li>
                        <li><img src="site/images/details-product/p06.jpg" alt="" width="500" height="500"></li>
                        <li><img src="site/images/details-product/p07.jpg" alt="" width="500" height="500"></li> --}}
                    </ul>
                    ...
                    <ul class="biolife-carousel slider-nav"
                        ...
                        @foreach ($product->images as $item)
                        <li><img src="{{ asset("storage/$item->path" ) }}" alt="" width="88" height="88"></li>
                        @endforeach
                    </ul>
					...
					<ul class="slides">
						<li data-thumb="#">
							<div class="thumb-image"> <img src="{{ asset("storage/$item->path" ) }}" data-imagezoom="true"
            ...
            <div class="action-form">
                ...
                <div class="buttons">
                    <a href="{{ url("/add_product/$product->id") }}" class="btn add-to-cart-btn">add to cart</a>
                    <p class="pull-row">
                ...
                <div class="acepted-payment-methods">
                    <ul class="payment-methods">
                        <li><img src="site/images/card1.jpg" alt="" width="51" height="36"></li>
                        <li><img src="site/images/card2.jpg" alt="" width="51" height="36"></li>
                        <li><img src="site/images/card3.jpg" alt="" width="51" height="36"></li>
                        <li><img src="site/images/card4.jpg" alt="" width="51" height="36"></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="product-tabs single-layout biolife-tab-contain">
            <div class="tab-head">
                <ul class="tabs">
                    ...
                    <li class="tab-element"><a href="#tab_4th" class="tab-link">Customer Reviews <sup>(3)</sup></a>
                    </li>
                </ul>
            </div>
            <div class="tab-content">
                <div id="tab_1st" class="tab-contain desc-tab active">
                    <p class="desc">Quisque quis ipsum venenatis, fermentum ante volutpat, ornare enim. Phasellus
                        ...
                        ligula, varius sed enim vitae, posuere molestie velit. Morbi risus orci, congue in nulla
                        at,
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                                <div class="review-form-wrapper">
                                    ...
                                    <form action="{{ url('/') }}" name="frm-review" method="post">
                                        @csrf
                                    ...
                                    <div class="comment-container">
                                        <div class="row">
                                            <div class="comment-content col-lg-8 col-md-9 col-sm-8 col-xs-12">
                                                <p class="comment-in"><span class="post-name">{{ $item->product_name}}</span><span class="post-date">01/04/2018</span></p>
                                                <div class="rating">
                                                    <p class="star-rating"><span class="width-80percent"></span>
                                                    </p>
                                                </div>
                                                <p class="author">by: <b>{{ $item->name }}</b></p>
            ...
            <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile"
                    ...
                    <div class="contain-product layout-default">
                        <div class="product-thumb">
                            <a href="#" class="link-to-product">
                                <img src="site/images/products/p-13.jpg" alt="dd" width="270" height="270"
                ...
                <li class="product-item">
                    <div class="contain-product layout-default">
                        <div class="product-thumb">
                            <a href="#" class="link-to-product">
                                <img src="site/images/products/p-14.jpg" alt="dd" width="270" height="270"
                                    class="product-thumnail">
                            </a>
                        </div>
                        <div class="info">
                ...
                <li class="product-item">
                    <div class="contain-product layout-default">
                        <div class="product-thumb">
                            <a href="#" class="link-to-product">
                                <img src="site/images/products/p-15.jpg" alt="dd" width="270" height="270"
                                    class="product-thumnail">
                            </a>
                        </div>
                        <div class="info">
                ...
                <li class="product-item">
                    <div class="contain-product layout-default">
                        <div class="product-thumb">
                            <a href="#" class="link-to-product">
                                <img src="site/images/products/p-10.jpg" alt="dd" width="270" height="270"
                                    class="product-thumnail">
                            </a>
                        </div>
                        <div class="info">
                ...
                <li class="product-item">
                    <div class="contain-product layout-default">
                        <div class="product-thumb">
                            <a href="#" class="link-to-product">
                                <img src="site/images/products/p-08.jpg" alt="dd" width="270" height="270"
                                    class="product-thumnail">
                            </a>
                        </div>
                        <div class="info">
                ...
                <li class="product-item">
                    <div class="contain-product layout-default">
                        <div class="product-thumb">
                            <a href="#" class="link-to-product">
                                <img src="site/images/products/p-21.jpg" alt="dd" width="270" height="270"
                                    class="product-thumnail">
                            </a>
                        </div>
                        <div class="info">
                ...
                <li class="product-item">
                    <div class="contain-product layout-default">
                        <div class="product-thumb">
                            <a href="#" class="link-to-product">
                                <img src="site/images/products/p-18.jpg" alt="dd" width="270" height="270"
                                    class="product-thumnail">
                            </a>
                        </div>
                        <div class="info">
